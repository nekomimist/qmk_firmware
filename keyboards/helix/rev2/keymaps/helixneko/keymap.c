...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LGUI, KC_LALT, KC_LALT, M_LOWER, KC_SPC,  KC_SPC,  M_RAISE, KC_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_CAPS, _______, _______, _______, _______, _______, _______, KC_DEL,  _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
