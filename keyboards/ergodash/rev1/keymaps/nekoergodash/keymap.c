...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |Adjust|  ESC |  GUI |  Alt |||||||| Lower| Space| Space|||||||| Space| Space| Raise|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    ADJUST,  KC_ESC,  KC_LGUI, KC_LALT,          M_LOWER, KC_SPC , KC_SPC,        KC_SPC ,KC_SPC , M_RAISE,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_END ,                        KC_PGDN, KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_TAB,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_END ,                        KC_PGDN, KC_F6,    KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
