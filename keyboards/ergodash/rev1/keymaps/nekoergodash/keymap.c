...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |Adjust|  ESC |  GUI |  Alt |||||||| Lower| Lower| Space|||||||| Space| Raise| Raise|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    ADJUST,  KC_ESC,  KC_LGUI, KC_LALT,          M_LOWER, M_LOWER, KC_SPC,        KC_SPC, M_RAISE, M_RAISE,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
  ),
